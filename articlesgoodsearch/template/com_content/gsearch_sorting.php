...
<div class="ordering direction <?php echo (JFactory::getApplication()->input->getWord("orderto") ? JFactory::getApplication()->input->getWord("orderto") : $model->module_params->ordering_default_dir); ?>"></div>
