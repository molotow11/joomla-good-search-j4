...
<div class="gsearch-field-text-range custom-field">	
	...
	<input class="inputbox" name="<?php echo $name_from; ?>" placeholder="<?php echo JText::_("From"); ?>" value="<?php echo JFactory::getApplication()->input->getWord($name_from); ?>" />
	<input class="inputbox" name="<?php echo $name_to; ?>" placeholder="<?php echo JText::_("To"); ?>" value="<?php echo JFactory::getApplication()->input->getWord($name_to); ?>" />
</div>
