...
$active_min = JFactory::getApplication()->input->getWord($name_from, $min);
$active_max = JFactory::getApplication()->input->getWord($name_to, $max);
...
<div class="gsearch-field-slider custom-field">	
	...
	<div class="slider-wrapper">
		...
		<input class="inputbox" type="hidden" name="<?php echo $name_from; ?>" value="<?php echo JFactory::getApplication()->input->getWord($name_from, ""); ?>" />
		<input class="inputbox" type="hidden" name="<?php echo $name_to; ?>" value="<?php echo JFactory::getApplication()->input->getWord($name_to, ""); ?>" />
	</div>
</div>
