...
$active_min = JFactory::getApplication()->input->getWord("field{$field->id}-from", $min);
$active_max = JFactory::getApplication()->input->getWord("field{$field->id}-to", $max);
...
<div class="gsearch-field-slider custom-field">	
	...
	<div class="slider-wrapper">
		...
		<input class="inputbox" type="hidden" name="<?php echo "field{$field->id}-from"; ?>" value="<?php echo JFactory::getApplication()->input->getWord("field{$field->id}-from", ""); ?>" />
		<input class="inputbox" type="hidden" name="<?php echo "field{$field->id}-to"; ?>" value="<?php echo JFactory::getApplication()->input->getWord("field{$field->id}-to", ""); ?>" />
	</div>
</div>
