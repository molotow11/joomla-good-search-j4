...
<div class="gsearch-field-select tags">	
	...
	<div class="tag-cloud<?php echo $module->id; ?>" style="max-width: 250px;">
		<?php foreach($tags as $tag) { ?>
			<a href="#" data-tag-id="<?php echo $tag->id; ?>" class="label label-primary<?php if(in_array($tag->id, (array)$_REQUEST['tag'])) { ?> active<?php } ?>" style="display: inline-block; margin-bottom: 5px;">
				<?php echo $tag->title; ?>
			</a>
		<?php } ?>
	</div>
