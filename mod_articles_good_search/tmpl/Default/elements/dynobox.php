		<script type="text/javascript">
			...
			jQuery(document).ready(function($) {
				...
				$("#GSearch<?php echo $module->id; ?> .gsearch-cell").each(function() {
					...
					if(select.length > 0) {
						$(this).prepend("<div class='dynoloader' style='display: none; width: 20px; float: right; margin-top: 10px;'><img src='<?php echo JURI::root(); ?>modules/mod_articles_good_search/assets/images/loading.png' /></div>");
					}
				});
			}); 
